// Simple local server for development without database
...
app.post('/api/auth/register', (req, res) => {
  ...
  console.log('Mock registration:', { name, email, password: password ? '***' : 'missing' });
...
app.post('/api/auth/login', (req, res) => {
  ...
  console.log('Mock login:', { email, password: password ? '***' : 'missing' });
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`✅ Mock Backend API listening on port ${PORT}`);
